...
type ComplexityRoot struct {
	Mutation struct {
		CreateOrder func(childComplexity int, userID int, productID int, quantity int, status string) int
	}
...
type MutationResolver interface {
	CreateOrder(ctx context.Context, userID int, productID int, quantity int, status string) (*Order, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createOrder":
		...
		return e.complexity.Mutation.CreateOrder(childComplexity, args["user_id"].(int), args["product_id"].(int), args["quantity"].(int), args["status"].(string)), true
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateOrder(rctx, fc.Args["user_id"].(int), fc.Args["product_id"].(int), fc.Args["quantity"].(int), fc.Args["status"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.(*Order)
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order_product_id(ctx context.Context, field graphql.CollectedField, obj *Order) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2githubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋpansaniᚋorderᚑlistᚑgoᚋcmdᚋgraphqlᚐOrder(ctx context.Context, sel ast.SelectionSet, v *Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
